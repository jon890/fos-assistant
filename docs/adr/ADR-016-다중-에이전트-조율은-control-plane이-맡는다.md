...
- 조율 주체를 [ADR-017](ADR-017-무엇을-할지는-hermes-가-정하고-control-plane-은-경계만-갖는다.md) 이 바꿨다.
  ...
  **경계에 대한 결정은 그대로 유효하다.**
  요청 본문과 모델의 출력이 profile 이나 credential 을 정하지 못한다는 규칙이 그것이다.
- **아래의 사실 둘이 2026-09-20 의 재측정에서 틀린 것으로 드러났다.**
  ...
  고친 값은 [`hermes-integration.md`](../hermes-integration.md) 가 갖는다.
